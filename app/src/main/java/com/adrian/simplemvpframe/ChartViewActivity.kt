...
import com.adrian.simplemvpframe.views.SingleColChartView
...
class ChartViewActivity : AppCompatActivity() {
    ...
    private fun initBarChart1() {
        ...
        val data1 = intArrayOf(300, 500, 550, 500, 300, 700, 800, 750, 550, 600, 400, 300, 400, 600, 500, 700, 300, 500, 550, 500, 300, 700, 800, 750, 550, 600, 400, 300, 400, 600, 500)
