...
import com.adrian.simplemvpframe.utils.AssetsUtils;
import com.adrian.simplemvpframe.views.wheel_view2.OnItemSelectedListener;
import com.adrian.simplemvpframe.views.wheel_view2.WheelView;
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.tv_confirm) {
            if (onAddressListener != null) {
                ...
                String mCurrentProvinceName = mProvinceDatas[mViewProvince.getSelectedItem()];

                int cityPos = mViewCity.getSelectedItem();
                ...
                int districtPos = mViewDistrict.getSelectedItem();
